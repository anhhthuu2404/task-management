...
graph TD
    ...
    subgraph Frontend [1. Frontend Layer - Angular Application]
        UI[Giao diện UI <br/> project.component.* <br/> Toast & UI State]
        Service[Quản lý SignalR / API <br/> notification.service.ts & RestService]
    ...
    subgraph Backend [2. Backend Layer - TaskManagement Solutions]
        ...
        App[Nghiệp vụ Application <br/> TaskManagement.Application <br/> ProjectAppService]
        ...
        App -->|4. Push Real-time Event on Project/Task Create/Update| Host
    end

    subgraph Database [3. Database Layer]
        DB[(SQL Server Database <br/> Projects, Milestones, Members Tables)]
    end

    Service -->|2. Connect WebSocket & Send HTTP Requests| Host
