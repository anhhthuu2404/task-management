...
namespace TaskManagement.SysMasterLists;

[Authorize(TaskManagementPermissions.SysMasterLists.Default)]
public class SysMasterListAppService : ApplicationService, ISysMasterListAppService
{
    ...
    [Authorize(TaskManagementPermissions.SysMasterLists.Create)]
    ...
    [Authorize(TaskManagementPermissions.SysMasterLists.Edit)]
    ...
    [Authorize(TaskManagementPermissions.SysMasterLists.Delete)]
