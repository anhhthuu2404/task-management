...
{
    [Authorize(TaskManagementPermissions.Languages.Default)]
    public class LanguageAppService : ApplicationService, ILanguageAppService
    {
        ...
        [Authorize(TaskManagementPermissions.Languages.Create)]
        ...
        [Authorize(TaskManagementPermissions.Languages.Edit)]
        ...
        [Authorize(TaskManagementPermissions.Languages.Delete)]
