...
[Authorize(TaskManagementPermissions.LanguageTexts.Default)]
public class LanguageTextAppService : ApplicationService, ILanguageTextAppService
{
    ...
    [Authorize(TaskManagementPermissions.LanguageTexts.Create)]
    ...
    [Authorize(TaskManagementPermissions.LanguageTexts.Edit)]
    ...
    [Authorize(TaskManagementPermissions.LanguageTexts.Delete)]
